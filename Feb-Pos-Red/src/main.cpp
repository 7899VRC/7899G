...
driveAngle(34, 0, 1000);
driveAngle(5, -35, 1500);//arc
wait(250, msec);
currentState = alliance;
wait(500, msec);
driveAngle(-9, -35, 500);
driveAngle(-18, -0, 1100);//arc back
currentState = idle;
gyroTurn(90, 800);
driveAngle(-34, 115, 1300, 10, 6, 1.2);
driveAngle(-4, 115, 400, 10, 6);//arc 4 goal
mogo_mech.set(true);
wait(500, msec);
hook.spin(forward, 100, pct);
gyroTurn(90, 500);
driveAngle(20, 90, 700);
driveAngle(-5, 90, 300);
wait(250, msec);
gyroTurn(145, 700);
//  wait(500, msec);
...
driveAngle(65, 145, 1500, 10, 4.5, 1.2);
wait(200, msec);
driveAngle(-30, 145, 1000);
gyroTurn(45, 700);
hook.stop();
hook.spinFor(-100, deg);
mogo_mech.set(false);
driveAngle(33.5, 45, 1000);
currentState = scoring;
